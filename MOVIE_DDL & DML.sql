...
CREATE TABLE MEMBER (                     
   ...
   ADDRESS   VARCHAR2(100)   NOT NULL,   -- 유저 주소
...
values('hong', '1234', '홍길동', 'abc@naver.com', sysdate);

INSERT INTO member(member_id, password, name, email, reg_date)
values('lee', '1234', '이진선', 'lee@naver.com', sysdate);

INSERT INTO member(member_id, password, name, email, role_id, address, phone, reg_date)
values('jang', '1234', '장발장', 'jang@naver.com',  'member', '인천 연수구 국제대로 123-2', '010-3333-3422', sysdate);


INSERT INTO member(member_id, password, name, email, reg_date)
values('kim', '1234', '김이순', 'kim@naver.com', sysdate);
