...
public class BoardController {
	...
	/*    *//**
			 ...
			 *//*
				 ...
				 * { try { log.info("Received spoiler value from form: {}", spoiler);
				 ...
				 * 
				 * log.info("Saving board: {}", boardVo); service.insertBoard(boardVo);
				 ...
				 * redirectAttributes.addFlashAttribute("board", boardVo); return
				 * "redirect:/board/insert"; } }
				 */
	 ...
	 */
	@PostMapping("/reply")
	public String replyBoard(BoardVo replyBoard, @RequestParam(value = "spoiler", required = false) String spoiler,
			RedirectAttributes redirectAttributes) {
		try {
			// 부모 게시물 정보 가져오기
