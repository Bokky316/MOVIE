        ...
        <div class="row justify-content-center"> <!-- 가운데 정렬을 위한 클래스 추가 -->
            <div class="col-lg-7"> <!-- 7칸 차지하는 컬럼 -->
		         <form class="user" id="insertForm"
						...
						<div class="form-group row">
							...
							<div class="form-group">
								<label for="phoneInput" class="form-label">휴대폰 번호</label> <input
									type="text" class="form-control" id="phoneInput"
					...
					<div class="text-center">
						<a class="small"
							href="${pageContext.request.contextPath}/login">이미 계정이 있으신가요?</a>
					</div>
				</div>
			</div>
       </section>
		...
		.ready(
				function() {
					...
					function validateFormInputs(event) {
						...
						const phone = $("#phoneInput").val().replace(
								/\s+/g, '');
