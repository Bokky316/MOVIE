...
<section class="projects-section bg-light" id="projects">
	<div class="container px-4 px-lg-5">
		<div class="card-body">
			<!-- 영화명 -->
			<div class="mb-3">
				<label class="form-label"><strong>영화명</strong></label> <input
					type="text" class="form-control" value="${movie.name}" readonly>
			</div>
			<!-- 영화 ID -->
			<div class="mb-3">
				<label class="form-label"><strong>영화 ID</strong></label> <input
					type="text" class="form-control" value="${movie.movieId}" readonly>
			</div>
			<!-- 설명 -->
			<div class="mb-3">
			...
			<!-- 개봉일 -->
			<div class="mb-3">
				<label class="form-label"><strong>개봉일</strong></label> <input
					type="text" class="form-control"
					value="<fmt:formatDate value='${movie.movieDate}' pattern='yyyy-MM-dd' />"
					readonly>
			</div>
			<!-- 등록일 -->
			<div class="mb-3">
				<label class="form-label"><strong>등록일</strong></label> <input
					type="text" class="form-control"
					value="<fmt:formatDate value='${movie.regDate}' pattern='yyyy-MM-dd HH:mm:ss' />"
					readonly>
			</div>
